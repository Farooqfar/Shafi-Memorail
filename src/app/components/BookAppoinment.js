...
export default function BookAppoinment() {
    return (
        <section className="w-full h-full">
            ...
            <div className="flex-1 flex flex-col justify-center items-center mx-lg:w-100 max-lg:h-52">
            ...
            <div className="flex-1 flex flex-col justify-center items-center  max-lg:w-100 max-lg:h-52">

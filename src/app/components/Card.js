...
export default function Card() {
    return (
        <section className="flex items-center justify-center p-10 max-lg:flex-wrap max-lg:p-10 max-lg:gap-1">
            ...
            <div className="bg-[#F7F7F7] w-100 h-60 flex justify-center  gap-4 flex-col p-10 border-r-1 border-white max-sm:p-4">
                <div>
                    <FaUserDoctor className="text-[#1DD2C8] text-5xl" />

                </div>
                <h1 className="text-black  text-3xl">Family Health</h1>
                <p className="text-[#809997] text-lg">We understand the importance of family health overall well-being.</p>
            </div>
            <div className="bg-[#F7F7F7] w-100 h-60 flex justify-center gap-4 flex-col p-10 max-sm:p-4">
                <div>
